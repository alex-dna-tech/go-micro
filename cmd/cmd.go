...
import (
	...
	nbroker "micro.labqa.pp.ua/v6/broker/nats"
	rabbit "micro.labqa.pp.ua/v6/broker/rabbitmq"
	"micro.labqa.pp.ua/v6/cache"
	"micro.labqa.pp.ua/v6/cache/redis"
	"micro.labqa.pp.ua/v6/client"
	"micro.labqa.pp.ua/v6/config"
	"micro.labqa.pp.ua/v6/debug/profile"
	"micro.labqa.pp.ua/v6/debug/profile/http"
	"micro.labqa.pp.ua/v6/debug/profile/pprof"
	...
	"micro.labqa.pp.ua/v6/registry/nats"
	"micro.labqa.pp.ua/v6/selector"
	"micro.labqa.pp.ua/v6/server"
	mprofile "micro.labqa.pp.ua/v6/service/profile"
	"micro.labqa.pp.ua/v6/store"
	"micro.labqa.pp.ua/v6/store/mysql"
	natsjskv "micro.labqa.pp.ua/v6/store/nats-js-kv"
	postgres "micro.labqa.pp.ua/v6/store/postgres"
	"micro.labqa.pp.ua/v6/transport"
	ntransport "micro.labqa.pp.ua/v6/transport/nats"
)
