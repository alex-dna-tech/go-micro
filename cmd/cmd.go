...
import (
	...
	nbroker "micro.labqa.pp.ua/broker/nats"
	rabbit "micro.labqa.pp.ua/broker/rabbitmq"
	"micro.labqa.pp.ua/cache"
	"micro.labqa.pp.ua/cache/redis"
	"micro.labqa.pp.ua/client"
	"micro.labqa.pp.ua/config"
	"micro.labqa.pp.ua/debug/profile"
	"micro.labqa.pp.ua/debug/profile/http"
	"micro.labqa.pp.ua/debug/profile/pprof"
	"micro.labqa.pp.ua/debug/trace"
	"micro.labqa.pp.ua/events"
	"micro.labqa.pp.ua/logger"
	mprofile "micro.labqa.pp.ua/service/profile"
	"micro.labqa.pp.ua/registry"
	"micro.labqa.pp.ua/registry/consul"
	"micro.labqa.pp.ua/registry/etcd"
	"micro.labqa.pp.ua/registry/nats"
	"micro.labqa.pp.ua/selector"
	"micro.labqa.pp.ua/server"
	"micro.labqa.pp.ua/store"
	"micro.labqa.pp.ua/store/mysql"
	natsjskv "micro.labqa.pp.ua/store/nats-js-kv"
	postgres "micro.labqa.pp.ua/store/postgres"
	"micro.labqa.pp.ua/transport"
	ntransport "micro.labqa.pp.ua/transport/nats"
)
