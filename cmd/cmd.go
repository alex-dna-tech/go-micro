...
import (
	...
	nbroker "micro.labqa.pp.ua/v5/broker/nats"
	rabbit "micro.labqa.pp.ua/v5/broker/rabbitmq"
	"micro.labqa.pp.ua/v5/cache"
	"micro.labqa.pp.ua/v5/cache/redis"
	"micro.labqa.pp.ua/v5/client"
	"micro.labqa.pp.ua/v5/config"
	"micro.labqa.pp.ua/v5/debug/profile"
	"micro.labqa.pp.ua/v5/debug/profile/http"
	"micro.labqa.pp.ua/v5/debug/profile/pprof"
	"micro.labqa.pp.ua/v5/debug/trace"
	"micro.labqa.pp.ua/v5/events"
	"micro.labqa.pp.ua/v5/logger"
	mprofile "micro.labqa.pp.ua/v5/service/profile"
	"micro.labqa.pp.ua/v5/registry"
	"micro.labqa.pp.ua/v5/registry/consul"
	"micro.labqa.pp.ua/v5/registry/etcd"
	"micro.labqa.pp.ua/v5/registry/nats"
	"micro.labqa.pp.ua/v5/selector"
	"micro.labqa.pp.ua/v5/server"
	"micro.labqa.pp.ua/v5/store"
	"micro.labqa.pp.ua/v5/store/mysql"
	natsjskv "micro.labqa.pp.ua/v5/store/nats-js-kv"
	postgres "micro.labqa.pp.ua/v5/store/postgres"
	"micro.labqa.pp.ua/v5/transport"
	ntransport "micro.labqa.pp.ua/v5/transport/nats"
)
